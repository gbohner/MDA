...
% WARP:         the warp transform (used only in homography case),
% TRANSFORM:    the type of adopted transform('affine' or 'homography')
% 
% Output:
% J:            The jacobian matrix J
%--------------------------------------
% $ Ver: 1.1.0, 7/1/2012,  released by Georgios D. Evangelidis, Fraunhofer IAIS.
